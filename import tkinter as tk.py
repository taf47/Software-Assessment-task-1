...
class TriangleLearningApp:
    ...
    def show_tutorial(self):
        ...
        try:
            ...
            img = img.resize((300, 500), Image.LANCZOS)
            self.triangle_img = ImageTk.PhotoImage(img)
            right_frame = tk.Label(self.content_frame, image=self.triangle_img, bg=self.colors[mode]['content_bg'])
            right_frame.pack(side="right", padx=10, pady=10)
        except:
            print("Triangle image not found or failed to load.")
